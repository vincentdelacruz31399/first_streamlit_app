...
try:
        ...
        if not add_my_fruit:
         streamlit.error("Please select a fruit you like to add") #error message if not part of fruit list
        else:
                ...
                streamlit.clear(add_my_fruit) #clear value in the add my fruit
